...
function createDownloadLink(blob) {
	...
	upload.addEventListener("click", function(event){
        ...
        xhr.onload = function(e) {
            if (this.readyState === 4) {
                ...
                if (result.status != 0) {
                    ...
                    modalContent.innerText = result.message;
                    modalCloseButton.className = "btn btn-danger";
                } else {
                    if (result.recognized == 0) {
                        ...
                        modalContent.innerText = result.message;
                        modalCloseButton.className = "btn btn-success";
                    }
                }
        ...
        var fd = new FormData();
        fd.append("id", document.getElementById("employeeID").value);
        fd.append("audio_data", blob, filename);
		xhr.open("POST", "/recognize_api", true);
		xhr.send(fd);
	})
